...
# Configured with: './configure' '--target-list=x86_64-softmmu,i386-softmmu,arm-softmmu' '--prefix=/home/hari/Desktop/project/faros/faros/panda/qemu/install' '--disable-pie' '--disable-xen' '--disable-libiscsi' '--enable-llvm' '--with-llvm=/usr/lib/llvm-3.3' '--extra-cflags=-O2 -I/usr/local/include' '--extra-cxxflags=-O2' '--extra-ldflags=-L/usr/local/lib -L/usr/local/lib64 -L/usr/local/lib -lprotobuf-c -lprotobuf -lpthread'
all:
prefix=/home/hari/Desktop/project/faros/faros/panda/qemu/install
bindir=${prefix}/bin
libdir=${prefix}/lib
...
VERSION=1.0,1
PKGVERSION=
SRC_PATH=/home/hari/Desktop/project/faros/faros/panda/qemu
EXTRA_PLUGINS_PATH=/home/hari/Desktop/project/faros/faros/panda/qemu
